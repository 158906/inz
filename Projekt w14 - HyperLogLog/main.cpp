...
int main(int argc, char** argv) {
    ...
    {         
		...
		////////////////////////////////////////////KONIEC WYŒWIETLANIA
           	...
           	//cout<<"pow(64.0,2) = :"<<pow(64.0,2)<<endl;
           	cout<<"alpha_64 = :"<<alpha_64<<endl;
           	cout<<"S = :"<<S<<endl;
           //	cout<<"S/64 = :"<<S/64.0<<endl;
           	
           	int n = pow(64.0,2)*alpha_64/S; // przy dzieleniu przez alpha_64 ³adnie wychodzi ,ale to raczej ma byæ w ten sposób
